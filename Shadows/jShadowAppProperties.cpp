...
void jShadowAppSettingProperties::Setup(jAppSettingBase* appSetting)
{
	...
	appSetting->AddVariable("PosX", MockCameraPos.x);
	appSetting->SetGroup("PosX", "MockCamera");
	appSetting->AddVariable("PosY", MockCameraPos.y);
	appSetting->SetGroup("PosY", "MockCamera");
	...
	appSetting->AddVariable("Possess", PossessMockCamera);
	appSetting->SetGroup("Possess", "MockCamera");
	appSetting->AddVariable("PossessOnlyCameraPP", PossessOnlyMockCameraPP);
	appSetting->SetGroup("PossessOnlyCameraPP", "MockCamera");	
	...
	appSetting->SetGroup("TargetY", "MockCamera");
	appSetting->AddVariable("TargetZ", MockCameraTarget.z);
	appSetting->SetGroup("TargetZ", "MockCamera");

	appSetting->AddVariable("CubePosX", CubePos.x);
	appSetting->SetGroup("CubePosX", "Cube");
	appSetting->AddVariable("CubePosY", CubePos.y);
	appSetting->SetGroup("CubePosY", "Cube");
	appSetting->AddVariable("CubePosZ", CubePos.z);
	appSetting->SetGroup("CubePosZ", "Cube");

	appSetting->AddVariable("CubeScaleX", CubeScale.x);
	appSetting->SetGroup("CubeScaleX", "Cube");
	appSetting->AddVariable("CubeScaleY", CubeScale.y);
	appSetting->SetGroup("CubeScaleY", "Cube");
...
void jShadowAppSettingProperties::Teardown(jAppSettingBase* appSetting)
{
	...
	appSetting->RemoveVariable("CubePosZ");
