...
//////////////////////////////////////////////////////////////////////////
// jLightIndexedDeferredRenderer
jLightIndexedDeferredRenderer::~jLightIndexedDeferredRenderer()
{
}

void jLightIndexedDeferredRenderer::Setup()
{
...
void jLightIndexedDeferredRenderer::Teardown()
{
	
}

void jLightIndexedDeferredRenderer::ShadowPrePass(const jCamera* camera)
{
...
void jLightIndexedDeferredRenderer::RenderPass(const jCamera* camera)
{
...
void jLightIndexedDeferredRenderer::DebugRenderPass(const jCamera* camera)
{
...
void jLightIndexedDeferredRenderer::BoundVolumeRenderPass(const jCamera* camera)
{
...
void jLightIndexedDeferredRenderer::PostProcessPass(const jCamera* camera)
{
...
void jLightIndexedDeferredRenderer::PostRenderPass(const jCamera* camera)
{
...
void jLightIndexedDeferredRenderer::DebugUIPass(const jCamera* camera)
{
