...
void jRenderObject::SetTextureProperty(const jShader* shader, jMaterialData* materialData)
{
	if (materialData)
	{
		...
		if (tex_object4)
		{
			auto tex_object4_param = new jMaterialParam();
			tex_object4_param->Name = "tex_object4";
			tex_object4_param->Texture = tex_object4;
			tex_object4_param->SamplerState = samplerState4;
			materialData->Params.push_back(tex_object4_param);
			useTexture = true;
		}
		if (tex_object5)
		{
			auto tex_object5_param = new jMaterialParam();
			tex_object5_param->Name = "tex_object5";
			tex_object5_param->Texture = tex_object5;
			tex_object5_param->SamplerState = samplerState5;
			materialData->Params.push_back(tex_object5_param);
			useTexture = true;
		}
		if (tex_object6)
		{
			auto tex_object6_param = new jMaterialParam();
			tex_object6_param->Name = "tex_object6";
			tex_object6_param->Texture = tex_object6;
			tex_object6_param->SamplerState = samplerState6;
			materialData->Params.push_back(tex_object6_param);
			useTexture = true;
		}
		if (tex_object7)
		{
			auto tex_object6_param = new jMaterialParam();
			tex_object6_param->Name = "tex_object7";
			tex_object6_param->Texture = tex_object7;
			tex_object6_param->SamplerState = samplerState7;
			materialData->Params.push_back(tex_object6_param);
			useTexture = true;
		}
